...
public class B {
	...
	public static void main(String[] args) {
		...
		int a = sc.nextInt();
		int b = sc.nextInt();
		Fraction r = new Fraction(b, a);
		boolean f = true;
		for (int i = 0; i < n - 2; i++) {
			a = sc.nextInt();
			f &= r.equals(new Fraction(a, b));
			b = a;
		}
	...
	private static class Fraction {
		...
		public Fraction pow(int i) {
			long n = 1, d = 1;
			for (long nu = numerator, de = denominator; i > 0; i >>= 1) {
				if ((i & 1) == 1) {
					n *= nu;
					d *= de;
				}
		...
		public String getDecimal(int n) {
