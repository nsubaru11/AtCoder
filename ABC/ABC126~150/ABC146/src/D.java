...
public final class D {
	...
	private static void solve() {
		...
		out.println(max(ans)).println(ans);
	}
	...
	private static void debugln(final Object... args) {
		if (DEBUG) {
			out.flush();
			System.err.println(stream(args).map(D::stringify).collect(Collectors.joining("\n", "\n", "")));
		}
	}
