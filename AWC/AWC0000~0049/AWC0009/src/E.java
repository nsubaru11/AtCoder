...
public final class E {
	...
	private static void solve() {
		int n = sc.nextInt();
		int q = sc.nextInt();
		IntSegmentTree max = new IntSegmentTree(n, Integer::max, Integer.MIN_VALUE);
		IntSegmentTree min = new IntSegmentTree(n, Integer::min, Integer.MAX_VALUE);
		for (int i = 0; i < n; i++) {
			int a = sc.nextInt();
			max.set(i, a);
			min.set(i, a);
		...
		while (q-- > 0) {
			int l = sc.nextInt0();
			int r = sc.nextInt0();
			out.println(max.query(l, r) - min.query(l, r));
		}
	}
